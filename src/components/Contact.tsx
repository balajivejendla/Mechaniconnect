...
const Contact = () => {
  ...
  return (
    <section id="contact" className={`py-16 ${darkMode ? 'bg-gray-900' : 'bg-white'} transition-colors duration-200`}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className={`${darkMode ? 'bg-gray-800' : 'bg-gray-50'} rounded-lg p-8`}>
